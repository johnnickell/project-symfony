...
|--------|------------|---------|
| [T-00003 — Establish the Symfony Complete Platform Profile](00003-TICKET.md) | [PRD-00002](../specs/00002-PRD.md) | Repaired PR #6 around adapter-owned entrypoints, explicit web middleware, private capability-scoped providers, production-binding test exposure, complete compiler-pass proof, durable locks, and exact receipt authority with no event-sourcing infrastructure. |
