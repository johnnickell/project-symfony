...
noninteractive completion gate used by GitHub Actions. `planning/README.md` names the local planning authority,
while `planning/tickets/BOARD.md` gives the current execution order.
